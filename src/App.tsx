...
function AppContent() {
  const { isAuthenticated, user, logout, authLoading } = useApp()
    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      <nav className="bg-gray-800 border-b border-gray-700 px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <NavLink to="/" className="text-xl font-bold text-purple-400 hover:text-purple-300 transition-colors">
            Poker App
          </NavLink>
          <div className="flex items-center gap-6">
            ...
            <NavLink to="/hands" className={linkClass}>
              Hands
            </NavLink>
